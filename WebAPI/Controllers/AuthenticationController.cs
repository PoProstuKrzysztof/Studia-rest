...
public class AuthenticationController : ControllerBase
{
    ...
    public AuthenticationController(UserManager<UserEntity> manager, ILogger<AuthenticationController> logger,
        IConfiguration configuration, JwtSettings jwtSettings, IQuizUserService service)
    {
        _manager = manager;
        _logger = logger;
    ...
    public ActionResult SaveAnswer([FromBody] QuizItemAnswerDto dto, [FromRoute] int quizId, [FromRoute] int itemId)
    {
        try
        {
